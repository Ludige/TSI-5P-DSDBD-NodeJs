...
router.get('/user/me', Auth.private, UserController.getStates);
router.put('/user/edit', UserValidator.editAction, Auth.private, UserController.editAction);
...
// http://localhost:7778/tasks/edit
